...
\begin{itemize}
    ...
    \item[\circled{H}]  The gray part is what we call a \emph{handle of index $k$}, and is homeomorphic to $B^{k} \times B^{n-k}$.
        This is the only non-trivial part of our cobordism.
        We call the bottom part of the border the \emph{attachment region}, i.e. $S^{k-1} \times B^{n-k}$.
\end{itemize}
\begin{marginfigure}
    \centering
...
\begin{description}
    \item[$0$-handle] $B^0 \times B^{1} = [-1, 1]$, with attachment region $\O$. \todo{These should probably be open intervals\ldots} \hfill \minifig{1cm}{handle-1-0} 
        
    \item[$1$-handle]   $B^{1} \times  B^{0} = [-1, 1]$ with attachment region $S^{0} = \{-1, 1\}$.  \hfill \minifig{1cm}{handle-1-1}
\end{description}
...
\begin{description}
    \item[$0$-handle] $B^{0} \times B^{2}$ with attachment region $\O$. \hfill \minifig{1cm}{handle-2-0}
    \item[$1$-handle] $B^{1} \times B^{1}$ with attachment region $B^1 \times S^{0}$. \hfill\minifig{1cm}{handle-2-1}
    \item[$2$-handle] $B^{2} \times B^{0}$ with attachment region $B_0 \times S_1$. \hfill\minifig{1cm}{handle-2-2}
\end{description}
...
\begin{description}
    \item[$0$-handle] $ B^0 \times B^{3}$ with attachment region $\O$ 
        \hfill\minifig{1cm}{handle-3-0}
    \item[$1$-handle] $ B^1 \times B^{2}$ with attachment region $ B^2 \times S^{0}$
        \hfill\minifig{1cm}{handle-3-1}
    \item[$2$-handle] $ B^2 \times B^{1}$ with attachment region $ B_1 \times S_1$
        \hfill\minifig{1cm}{handle-3-2}
    \item[$3$-handle] $ B^3 \times B^{0}$ with attachment region $S^{2}$
...
\begin{eg}[Handle decomposition of $S^{3}$]
    ...
    Then handle decomposition is then a $0$-handle ($B^{3}$) glued to a $3$-handle (which is also diffeomorphic to $B^{3}$).
\end{eg}

...
The core idea of the proof is very geometrical and depends on the fact that compact one-dimensional manifolds with boundary have an even number of boundary points.\sidenote{TODO: reference or prove!}
...
\begin{proof}
    ...
    \todo{This is always possible because the sphere is compact.}
...
\todo{REWORD With the preceding technical lemmas,
we are ready to complete the proof showing that the Morse complex is actually a complex, i.e.\ $\partial^2 = 0$, with yet another technical lemma.}
...
\todo{Its homology is under mild conditions}\sidenote{When?} isomorphic to singular homology.\sidenote{
 One can prove this by verifying the Eilenberg--Steenrod axioms, which characterize singular homology.
}
...
\begin{align*}
    ...
    \begin{itemize}
        ...
        \item \todo{Fix ugly figures. Maybe split in two figures}
        \item \todo{Add end points of intervals for 1-simplexes in figures}

...
\todo{Its homology is under mild conditions}\sidenote{When?} isomorphic to singular homology.\sidenote{
 One can prove this by verifying the Eilenberg--Steenrod axioms, which characterizes singular homology.
}
...
\begin{proof}
    As stated before, we follow Hatcher\sidecite{hutchings2002lecture}.

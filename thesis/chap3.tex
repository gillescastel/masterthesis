...
\begin{proof}
    ...
    Let us now try to construct a trajectory that is the `accumulation trajectory'\sidenote{By which we simply mean an accumulation point of the sequence $\ell_n$, but this can be confusing because it is not a point in the geometrical sense of the word} of $\ell_n$.

...
\end{eg}
    ...
    An obtrusion to attaching two handles at the same time would then be the intersection of stable and unstable manifolds. We will make this more precies in the next section.

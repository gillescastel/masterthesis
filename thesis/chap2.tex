...
For the statement and proof, we follow notes of lectures by Milnor on the $h$-cobordism theorem.\sidecite{hcobord}
The proof is based on the original proof by Milnor\sidecite{cairns2015differential,huebsch1964bowl}.
For a proof more base on the handle attaching approach, we refer the reader to `Differential Geometry' by Kosinski.\sidecite{kosinski2013differential}
There is also a nice proof by Laudenbach reducing the general case to dimension one, where the problem is easy to solve.\sidecite{laudenbach2013proof}

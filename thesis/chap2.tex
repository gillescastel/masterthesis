...
\end{eg}
    ...
    \begin{definition}[Smale condition]
        ...
        .\] 
    \end{definition}
    Later we will prove that this condition is not at all restricting: we can always perturb the pseudo-gradient field such that it satisfies the Smale condition.
...
\end{definition}
\todo{Add example of self-indexing morse function of torus}

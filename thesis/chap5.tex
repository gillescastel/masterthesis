...
Having discussed a multitude of cancellation theorems, we are ready to prove the minimality of the Morse inequalities, as first proven by Smale.\sidecite{smale1960generalized}
...
\begin{itemize}
    ...
    \item $\manp$, the category of piecewise linear manifolds.\sidenote{For an introduction on piecewise linear manifolds, see \fullcite{rourke2012introduction}}
\end{itemize}
